...
2. Enforce Conventions Alignment  
   - Confirm the changed code follows the rules in `docs/convention.md` (including presentation wiring: views own controllers, only presenters attach to views).  
   - Flag any deviations or new patterns that sidestep established conventions.  
...
6. Review Implementation Details  
